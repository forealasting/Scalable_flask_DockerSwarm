...
db_cpu1 = client['state']['cpu_u1']
db_cpu2 = client['state']['cpu_u2']
db_cpu3 = client['state']['cpu_u3']
db_cpu4 = client['state']['cpu_u4']
db_delay1 = client['containers']['delay1']
db_delay2 = client['containers']['delay2']
db_delay3 = client['containers']['delay3']
db_delay4 = client['containers']['delay4']
