...
'''
path = tmp_str + "/output_cpu_tmax30.txt"
path1 = tmp_str + "/output_cpu_tmax40.txt"
path2 = tmp_str + "/output_cpu_tmax50.txt"
'''
...
def cal_cpu(f, if_store):
    ...
    time_m.insert(0, 0)
    cpu_m.insert(0, 20)
    return time_m, cpu_m, resource_use




# Plot --------------------------------------
x1, y1, res1 = cal_cpu(f, 0)

# x2, y2, res2 = cal_cpu(f1, 0)

# x3, y3, res3 = cal_cpu(f2, 0)
