...
path1 = tmp_str + "/output_tmax40.txt"
path2 = tmp_str + "/output_tmax50.txt"
...
# Plot real data----------------
    ...
    x1, delay1 = cal_real_delay(f, use_tm, r, simulation_time)
    x2, delay2 = cal_real_delay(f1, use_tm, r, simulation_time)
    x3, delay3 = cal_real_delay(f2, use_tm, r, simulation_time)
    # delay4 = cal_delay(f3, 0, 100, simulation_time)
    # delay5 = cal_delay(f4, 1, 10, simulation_time)
    # x1 = [i for i in range(300)]
    y1 = delay1
